...
if [ -f "$VCF_DIR/json_to_tsv_2.py" ]; then
    cp "$VCF_DIR/json_to_tsv_2.py" "$JSON_DIR/"
else
    echo "WARNING: json_to_tsv_2.py not found in $VCF_DIR"
fi
...
SCRIPT_JSON="$JSON_DIR/json_to_tsv_2.py"
